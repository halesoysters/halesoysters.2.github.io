...
// First tile layer that will be the background of our map.
...
// DELIVERABLE THREE, ADD A THIRD LAYER:
// dark view tile layer that will be an option for the map.
let night = L.tileLayer('https://api.mapbox.com/styles/v1/mapbox/navigation-guidance-night-v3/tiles/{z}/{x}/{y}?access_token={accessToken}', {
